...
describe("parseEsv", () => {
    test.concurrent("parse james 1:1", () => {
    ...
    test.concurrent("parse psalm 23", () => {
    ...
    test.concurrent("parse 1 peter 1", () => {
    ...
    test.concurrent("parse song of solomon 3", () => {
    ...
    test.concurrent("parse song of solomon 4", () => {
    ...
    test.concurrent("parse psalm 145:13", () => {
...
describe("parseNextChapter", () => {
    ...
    test.concurrent("1 thessalonians 4", () => {
