    ...
    return (
        <div className="min-h-screen-1px container mx-auto flex max-w-page flex-col px-4 lg:px-0">
            <Head>
                ...
                <meta
                    name="description"
                    content="The Terms of Service for Type the Word. A typing practice tool that tracks your typing progress through the Bible. Improve your typing skills while meditating on God's word."
                />
                <meta
                    property="og:image"
